...
public class ServiceNumbers1 implements Serializable {
    ...
    private String port;
    private GameServiceNumber1 gameServiceNumber1;

    public ServiceNumbers1() {
    }
    ...
    @OneToOne(mappedBy = "serviceNumbers1")
    public GameServiceNumber1 getGameServiceNumber1() {
        return gameServiceNumber1;
    }

    public void setGameServiceNumber1(GameServiceNumber1 gameServiceNumber1) {
        this.gameServiceNumber1 = gameServiceNumber1;
    }
