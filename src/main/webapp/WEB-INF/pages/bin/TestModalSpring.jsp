...
<form id="basicBootstrapForm" class="form-horizontal"
    ...
    <%-- Passwork and verifu password --%>
    <div class="form-group hidden" >
        <label for="gameCateName-input" class="col-sm-2 control-label">M?t kh?u</label>
        <div class="col-sm-9">
            <input class="form-control" id="password" name="password" type="password" pattern="^\S{6,}$" onchange="this.setCustomValidity(this.validity.patternMismatch ? 'Must have at least 6 characters' : '');
